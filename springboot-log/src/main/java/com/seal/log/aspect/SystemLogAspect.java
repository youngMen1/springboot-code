package com.seal.log.aspect;

import com.seal.log.annotation.SystemControllerLog;
import com.seal.log.annotation.SystemServiceLog;
...
public class SystemLogAspect {
     ...
     */
    @Pointcut("@annotation(com.seal.log.annotation.SystemServiceLog)")
     ...
     */
    @Pointcut("@annotation(com.seal.log.annotation.SystemControllerLog)")
