package com.seal.easypoi.springbooteasypoi.config;
...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.seal.easypoi.springbooteasypoi.controller"))
